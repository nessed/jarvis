...
**HEAD** `04b5487 Retarget hosting to Azure for Students; AWS becomes the fallback` on `main`, 11 ahead, 0 behind origin.

**Working tree:** 1 changed (plus 15 untracked)

```
  M  CLAUDE.md
```

**Offline suite:** 1679 passed, 16 deselected in 73.09s (0:01:13) _(recorded 2026-09-09)_

**Live acceptance suite:** 1 passed, 1 warning in 34.04s _(recorded 2026-09-03)_

**Recent commits**

- `04b5487` Retarget hosting to Azure for Students; AWS becomes the fallback  _(2026-09-09)_
